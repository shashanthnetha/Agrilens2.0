...
export function LayeredText({
  ...
  const timelineRef = useRef<gsap.core.Timeline>(null as any)
      ...
      <ul className="list-none p-0 m-0 flex flex-col items-center">
        {lines.map((line, index) => {
          ...
          return (
            ...
            >
              <p
                className="leading-[55px] md:leading-[30px] px-[15px] align-top whitespace-nowrap m-0 text-white drop-shadow-[0_0_10px_rgba(212,175,55,0.4)]"
                style={
                  {
                    height: `${lineHeight}px`,
              ...
              <p
                className="leading-[55px] md:leading-[30px] px-[15px] align-top whitespace-nowrap m-0 text-[#D4AF37]"
                style={
                  {
                    height: `${lineHeight}px`,
                    lineHeight: `${lineHeight - 5}px`,
